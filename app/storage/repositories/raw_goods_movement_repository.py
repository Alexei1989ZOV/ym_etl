...
class RawGoodsMovementRepository:
    """
    Репозиторий для raw слоя отчёта по движению товаров.
    ...
    def bulk_insert(self, records: Iterable[RawGoodsMovementReport]) -> None:
        """
    ...
    def delete_by_date(self, target_date: date) -> None:
        ...
        self.session.query(RawGoodsMovementReport).filter(
            RawGoodsMovementReport.day == target_date
